...
const Carousel = () => {
  ...
  >
    <div id="mainCarousel" className="carousel slide py-3" data-bs-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active c-item">
          <img src="/img/card1.jpeg" className="d-block w-100 c-img" alt="Дизайн проект 1" />
        ...
        <div className="carousel-item c-item">
          <img src="/img/card2.jpeg" className="d-block w-100 c-img" alt="Дизайн проект 2" />
...
Заинтересованы в креативных идеях для вашего проекта?
        ...
        <div className="carousel-item c-item">
          <img src="/img/card3.jpeg" className="d-block w-100 c-img" alt="Дизайн проект 3" />
          <div className="carousel-caption d-none d-md-block">
          <h5 
