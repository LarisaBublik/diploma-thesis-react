  ...
  return (
    <footer className="d-flex flex-wrap justify-content-evenly align-items-center py-3 my-4 border-top">
      <div className="col-md-4 d-flex align-items-center">
        <span className="mb-3 mb-md-0 text-body-secondary fs-5">© 2024 Company: <a className="text-body" href="#">Bublikova Veronika</a></span>
      </div>
      ...
      <div className="col-md-5 d-flex justify-content-end">
        <ul className="nav col-md-4 list-unstyled d-flex">
          <li className="ms-3">
            <a className="text-body-secondary" href="https://wa.me/79096736674" target="_blank" rel="noopener noreferrer">
